    ...
    <div className="bg-gray-900">
      <Head>
        ...
        <meta
          ...
          content="TeSACCO is decentralized group savings application built and deployed on Polygon network. Currently its running on Polygon test-net MUMBAI"
        />
      ...
      <main className="flex flex-col flex-1 mt-20 min-h-screen">
